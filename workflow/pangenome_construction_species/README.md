# 🧬 Pangenome Analysis Workflow (Species)

**Created by:** Julian Torres Morales  
**Date:** December 8, 2025  

**Species** with at least 2 HMTs.
...
1. **Select Species with at least 2 HMTs** (n = 12)  
...
### Step 1 – Count HMTs per species

**Objective:**  
Identify taxa (HMTs) with at least two genomes (`contigs.DB`).

**Key Actions:**  
- Find Species with at least two HMTs
- Count the number of genomes per Species (all expected to have at least 2 genomes)

**Outputs:**  
- Two lists:  
  - Species with ≥2 genomes  
  - Species with only one genome  
